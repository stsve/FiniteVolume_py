...
#                                                                             #
#                                                                             #  
#       Auteurs: - Stéfane Sved (1569161)                                     #
#                - Virgile Garnier (2051886)                                  #
#-----------------------------------------------------------------------------#
...
def msolv2D(numelx,numely):
    global PNKSI, PNN,A,ETA,KSI,deta,vel,X,Y,solU,solV,tim2,flag,solPhip,fSx,fSy
...
#    Cp = 1
    ...
    up = np.zeros((np.size(are,0)))
    vp = np.zeros((np.size(are,0)))
