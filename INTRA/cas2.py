...
#nraff = np.array([2,4,8,16,32,64,128]) # Nombre de nelm doit etre egal au size de "solutions"
#
...
#ratio = H[4]/H[2]
#
#p1 = np.log((np.average(solutions[4])-np.average(solutions[2]))/(np.average(solutions[2])-np.average(solutions[0])))/np.log(ratio)
